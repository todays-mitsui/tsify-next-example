...
export function from_ts_namespace_into_rust_enum(a: number): number;
...
export function from_ts_number_into_rust_u64(a: number): number;
export function from_ts_number_into_rust_i64(a: number): number;
